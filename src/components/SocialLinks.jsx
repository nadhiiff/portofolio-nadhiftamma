...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nadhiftamma/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@nadhiftamma_",
    icon: Instagram,
    url: "https://www.instagram.com/nadhiftamma_/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@nadhiftamma",
    icon: Github,
    url: "https://github.com/nadhiftamma/",
    color: "#ffffff",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        ...
        data-aos="fade-down"
      >
        <span className="inline-block w-8 h-1 bg-red-700 rounded-full"></span>
        Connect With Me
      </h3>
