...
const Comment = memo(({ comment, formatDate, index, isPinned = false }) => (
    <div 
        className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:shadow-lg hover:-translate-y-0.5 ${
            isPinned 
                ? 'bg-gradient-to-r from-red-700/10 to-red-900/10 border-red-700/30 hover:bg-gradient-to-r hover:from-red-700/15 hover:to-red-900/15' 
                ...
                <div className="flex items-center justify-between gap-4 mb-2">
                    <div className="flex items-center gap-2">
                        <h4 className={`font-medium truncate ${
                            isPinned ? 'text-red-300' : 'text-white'
                        }`}>
                            {comment.user_name}
                        </h4>
                        {isPinned && (
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-maroon to-[#7A2E3B] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-maroon/20 active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
        ...
        <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl  backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <style jsx>{`
                ...
                .custom-scrollbar::-webkit-scrollbar-thumb {
                    background: rgba(185, 28, 28, 0.5); /* red-700 approx */
                    border-radius: 6px;
                }
