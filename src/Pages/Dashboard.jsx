...
export default function Dashboard() {
  ...
  return (
    ...
    <div className="flex text-white" style={{ height: '100dvh' }}>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-30 w-60 flex flex-col border-r border-white/8 bg-black backdrop-blur-xl transition-transform duration-300 lg:hidden ${
