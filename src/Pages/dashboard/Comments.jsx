...
const Card = ({ children, className = "" }) => (
  <div className={`relative group ${className}`}>
    <div className="absolute -inset-0.5 bg-gradient-to-r from-red-700 to-red-900 rounded-2xl blur opacity-10 group-hover:opacity-20 transition duration-500 pointer-events-none" />
    ...
    <div className="space-y-6">
          ...
          {[
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 sm:px-4 py-1.5 rounded-lg text-xs sm:text-sm transition-all duration-200 ${
                filter === tab.value
                  ? "bg-gradient-to-r from-red-500/25 to-red-800/20 border border-red-500/35 text-white font-medium"
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          { label: "Pinned", value: pinnedCount, color: "text-red-300" },
          {
            label: "Unpinned",
        ...
        <div className="space-y-2.5">
          {paginated.map((comment) => (
            <div key={comment.id} className="relative group">
              {comment.is_pinned && (
                <div className="absolute -inset-0.5 bg-gradient-to-r from-red-700 to-red-900 rounded-2xl blur opacity-15 pointer-events-none" />
              )}
              <div
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  {/* Avatar */}
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-red-500/20 to-red-800/20 border border-white/10 flex items-center justify-center shrink-0">
                    <img
